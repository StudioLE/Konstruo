...
mod tests {
    ...
    fn _spherical_to_cartesian__polar() {
        ...
        Vec3Extensions::assert_almost_equal_to(expected, actual);
    ...
    fn _cartesian_to_spherical() {
        ...
        Vec3Extensions::assert_almost_equal_to(expected.vector, spherical.vector);
        let round_trip = spherical.to_cartesian();
        Vec3Extensions::assert_almost_equal_to(cartesian, round_trip);
        let angle = Vec3Extensions::angle_between_on_plane(Vec3::X, cartesian, Vec3::Z);
