...
mod tests {
    ...
    fn _spherical_to_cartesian__polar() {
        ...
        expected.assert_almost_equal_to(actual);
    ...
    fn _cartesian_to_spherical() {
        ...
        expected.vector.assert_almost_equal_to(spherical.vector);
        let round_trip = spherical.to_cartesian();
        cartesian.assert_almost_equal_to(round_trip);
        let angle = Vec3::X.angle_between_on_plane(cartesian, Vec3::Z);
