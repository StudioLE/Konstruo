use bevy::prelude::*;
use geometrician_core::mathematics::constants::{EIGHTH_PI, QUARTER_PI};
use geometrician_core::mathematics::spherical_coordinate_system::spherical_to_cartesian;
use geometrician_core::ENVIRONMENT_MAX;
